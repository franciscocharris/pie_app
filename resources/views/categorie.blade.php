...
@section('plugins_css')
    <link rel="stylesheet" href=" {{ asset('vendor/electro/animate.css/animate.min.css') }} ">
    <link rel="stylesheet" href=" {{ asset('vendor/electro/hs-megamenu/src/hs.megamenu.css') }} ">
    <link rel="stylesheet" href=" {{ asset('vendor/electro/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.css') }} ">
    <link rel="stylesheet" href=" {{ asset('vendor/electro/fancybox/jquery.fancybox.css') }} ">
    <link rel="stylesheet" href=" {{ asset('vendor/electro/slick-carousel/slick/slick.css') }} ">
    <link rel="stylesheet" href=" {{ asset('vendor/electro/bootstrap-select/dist/css/bootstrap-select.min.css') }} ">
@stop
...
@section('plugins_js')
    <script src=" {{ asset('vendor/electro/appear.js') }} " ></script>
    <script src=" {{ asset('vendor/electro/jquery.countdown.min.js') }} " ></script>
    <script src=" {{ asset('vendor/electro/hs-megamenu/src/hs.megamenu.js') }} " ></script>
    <script src=" {{ asset('vendor/electro/svg-injector/dist/svg-injector.min.js') }} " ></script>
    <script src=" {{ asset('vendor/electro/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.concat.min.js') }} " ></script>
    <script src=" {{ asset('vendor/electro/jquery-validation/dist/jquery.validate.min.js') }} " ></script>
    <script src=" {{ asset('vendor/electro/fancybox/jquery.fancybox.min.js') }} " ></script>
    <script src=" {{ asset('vendor/electro/typed.js/lib/typed.min.js') }} " ></script>
    <script src=" {{ asset('vendor/electro/slick-carousel/slick/slick.js') }} " ></script>
    <script src=" {{ asset('vendor/electro/ion-rangeslider/js/ion.rangeSlider.min.js') }} " ></script>
    <script src=" {{ asset('vendor/electro/appear.js') }} " ></script>
    <script src=" {{ asset('vendor/electro/bootstrap-select/dist/js/bootstrap-select.min.js') }} " ></script>
@stop
